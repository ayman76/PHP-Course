    ...
    <main>
        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <?php if (isset($errors['notFound'])): ?>
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mt-10 sm:mx-auto sm:w-full sm:max-w-sm" role="alert">
                    <span class="block sm:inline"><?= $errors['notFound'] ?></span>
